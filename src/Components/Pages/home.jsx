...
//           <div className="products-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
//             {featuredCollections.map((product, index) => (
//               <div key={product.id} className="product-card bg-white rounded-2xl overflow-hidden shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-xl" data-aos="fade-up" data-aos-delay={(index % 4) * 100}>
//                 <div className="product-img h-64 overflow-hidden">
//                   <img 
//                     src={product.image} 
//                     alt={product.alt}
